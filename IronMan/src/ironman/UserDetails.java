...
public class UserDetails extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(email.equals("") || phone.equals("")||name.equals(""))
          JOptionPane.showMessageDialog(null, "Please enter all details");  
           ...
           JOptionPane.showMessageDialog(null, "email adress is invalid");  
        else if (!(phone.matches("[0-9]+") && phone.length() > 2))
            JOptionPane.showMessageDialog(null, "phone number should contains only numbers");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        IronManFace iron= new IronManFace();
